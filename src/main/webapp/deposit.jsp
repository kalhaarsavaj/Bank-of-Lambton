...
<body>
	...
	<div id="eta" class="col s12">
		...
		%>
		<h4 style="text-align: center" class="black lighten-3">DEPOSIT</h4>
		<form action="DepositServlet" method="post"
			class="col s12 withdraw_form" style="text-align: center">
			<div class="row">
				<div class="input-field col s12">
					<select id="deposit_account" name="deposit_account">
			...
			<div class="row">
				<div class="input-field col s12">
					<input placeholder="$0.00" id="deposit_amount"
						name="deposit_amount" type="number" required class="validate" min="1">
			...
			<div class="row">
				<div class="input-field col s12">
					<input id="deposit_date" value="23 August 2020" type="text"
						disabled class="validate"> <label for="deposit_date">Date:</label>
				</div>
			</div>
